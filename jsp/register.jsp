...
<div class="panel panel-default" style="margin:5%;margin-left:20%;margin-right:20%">
    ...
    <form  action="registerInBdd" method="get" style="margin:10px">
        <input id="registerName" name="register-name" type="text" placeholder="Nom" required/>
        </br>
        <input id="registerLogin" name="register-login" type="text" placeholder="Login" required/>
        </br>
        <input id="registerPassword" name="register-password" type="password" placeholder="Mot de passe" required/>
        </br></br>
